...
MUX_VAL(CONTROL_PADCONF_CCDC_DATA4, (IDIS | PU | M4 )) /* gpio_103 */\
...
MUX_VAL(CONTROL_PADCONF_CCDC_FIELD, (IEN | PI | M1 )) /* ccdc_data8 */\
MUX_VAL(CONTROL_PADCONF_CCDC_HD, (IEN | PU | M4 )) /* gpio_96 */\
