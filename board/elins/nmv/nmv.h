...
MUX_VAL(CONTROL_PADCONF_CCDC_DATA4, (IEN | PU | M7 )) /* safe_mode */\
...
MUX_VAL(CONTROL_PADCONF_CCDC_FIELD, (IEN | PU | M7 )) /* safe_mode */\
...
MUX_VAL(CONTROL_PADCONF_MMC1_DAT4, (IEN | PI | M0 )) /* mmc1_dat4 */\
MUX_VAL(CONTROL_PADCONF_MMC1_DAT5, (IEN | PI | M0 )) /* mmc1_dat5 */\
MUX_VAL(CONTROL_PADCONF_MMC1_DAT6, (IEN | PI | M0 )) /* mmc1_dat6 */\
MUX_VAL(CONTROL_PADCONF_MMC1_DAT7, (IEN | PI | M0 )) /* mmc1_dat7 */\
